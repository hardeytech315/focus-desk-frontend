...
const defaultTasks: Task[] = [
  { _id: '1', title: 'Design landing page wireframes', description: 'Create wireframes for the new landing page including hero section, features, and CTA.', status: 'completed', priority: 'high', deadline: '2026-03-20', createdAt: '2026-03-15T10:00:00Z', updatedAt: '2026-03-20T14:00:00Z' },
  { _id: '2', title: 'Set up CI/CD pipeline', description: 'Configure GitHub Actions for automated testing and deployment.', status: 'in-progress', priority: 'high', deadline: '2026-03-25', createdAt: '2026-03-18T09:00:00Z', updatedAt: '2026-03-22T11:00:00Z' },
  ...
  { _id: '7', title: 'Team standup notes', description: 'Prepare agenda and notes for tomorrow\'s standup meeting.', status: 'completed', priority: 'low', deadline: '2026-03-22', createdAt: '2026-03-21T08:00:00Z', updatedAt: '2026-03-22T09:00:00Z' },
];
...
export const TaskProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const setFilters = (f: Partial<TaskFilters>) => setFiltersState((p) => ({ ...p, ...f }));
